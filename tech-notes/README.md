...
| [0007](0007-xcode-27-2-json-xcproj-format.md) | Xcode 27.2+ Native JSON Project Format (`project.xcproj`) | Replacing legacy OpenStep `.pbxproj` with Apple's modern, hierarchical JSON `.xcproj` format designed for AI coding agents and human readability. |
